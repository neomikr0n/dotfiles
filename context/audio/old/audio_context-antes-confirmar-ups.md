...
| CyberPower CP1500PFCLCD; ficha aportada de variante CP1500PFCLCDa | UPS de casa; sufijo de la unidad por contrastar con etiqueta | $4,500 |
...
### CyberPower: ficha oficial añadida por el propietario

El documento aportado es la **ficha técnica oficial de dos páginas para CP1000PFCLCDa/CP1500PFCLCDa**, versión NEMA en español. Su tabla permite documentar la variante **CP1500PFCLCDa** con mucha más precisión. El inventario previo decía CP1500PFCLCD, sin «a»; queda únicamente confirmar ese sufijo en la etiqueta del aparato para asignar definitivamente esta revisión. No se mezclan las dos columnas del PDF. [Ficha CyberPower aportada](</home/n30/dotfiles/context/audio/Manual CyberPower_DS_CP1000-1500PFCLCDa_NEMA_es_v2.pdf>).

| Característica | CP1500PFCLCDa, columna correspondiente del documento |
|---|---|
| Topología / PFC | Línea interactiva; compatible con fuentes de PFC activo |
| Capacidad | **1,500 VA / 1,000 W** |
| Entrada nominal / intervalo | **120 V CA / 88–144 V CA**, 60 ±3 Hz |
| AVR | **Aumento único**; no se describe regulación continua de doble conversión |
| Salida en batería | Senoidal, **120 V ±5%** para carga de prueba menor del 60%; a cargas mayores la desviación puede superar el 5% |
| Frecuencia en batería | 60 Hz ±1% |
| Transferencia típica | **4 ms** |
| Enchufe / tomas | NEMA 5-15P / **12 tomas NEMA 5-15R** |
| Distribución de tomas | **6 con batería y supresión de sobretensiones; 6 sólo con supresión** |
| Autonomía publicada | **10 min a media carga; 2.5 min a carga completa** |
| Recarga típica / batería | **8 h**; plomo-ácido sellada, reemplazable por el usuario |
| Repuesto indicado | **RB1290X2**, un paquete de sustitución |
| Supresión de sobretensiones | **1,445 J**; filtro EMI/RFI declarado |
| Datos / carga USB | RJ45 de protección, entrada/salida; USB HID de gestión; USB-A y USB-C de carga |
| Dimensiones / masa | **100 × 281.5 × 354.1 mm / 11.3 kg** |
| Operación | **0–40 °C**; humedad 0–95% sin condensación |

**Qué aporta a la cadena:** mantiene alimentación durante ciertos cortes, eleva tensión cuando actúa su AVR y limita determinadas sobretensiones. La onda senoidal en batería es compatible con cargas de PFC activo. Sus puertos de carga USB no son una ruta de audio, y el USB de gestión no convierte al UPS en DAC. La protección RJ45 sólo interviene si el cableado pasa físicamente por ella; no está confirmado que el enlace LAN del Eversolo lo haga.
...
| CyberPower, ficha CP1500PFCLCDa | 1,500 VA/1,000 W; seis de sus doce tomas no tienen batería; capacidad y autonomía finitas; mantenimiento de batería | Ficha oficial ya disponible. Confirmar sufijo local y carga real; el filtro EMI/RFI no demuestra una mejora sonora medida |
...
1. **Alimentación:** placa exterior del Aune (tensión y consumo), placa del UPS y mapa de qué aparato va a cada toma; tensión que recibe y entrega el TM333 con el Aune en funcionamiento. No se necesita abrir los equipos.
...
Las fotografías comerciales se atribuyen a las publicaciones de Amazon consultadas el 12/09/2026; no se presentan como fotografías de las unidades del propietario. El transformador sí se ilustra con su fotografía. Los diagramas son explicativos, no planos de fabricación. Los manuales originales del RME, Aune y Eversolo conservados en esta carpeta siguen siendo la referencia de operación de esos equipos. Se añadió también la ficha técnica oficial CyberPower CP1000PFCLCDa/CP1500PFCLCDa, sin recrearla ni presentarla como un manual de servicio completo.
