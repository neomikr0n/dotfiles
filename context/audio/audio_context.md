...
| RME ADI-2 DAC FS, revisión C: ESS ES9028Q2M | Receptor digital, DAC y procesamiento de casa; chip identificado por etiqueta | $13,000 |
| Aune S17 Pro EVO | Amplificador de audífonos; versión de 220 V | $11,000 |
| Eversolo DMP-A6, modelo original | Reproductor de red de casa | $13,500 |
| CyberPower CP1500PFCLCD, sin «a» | Modelo confirmado por el propietario: 1,500 VA / 1,000 W, doce tomas | $4,500 |
| Par XLR WBC-PRO-Quad, ASIN B0CZRXDVBF | RME–Aune; 2 × 3.048 m; Amphenol AX3M/AXX3F; tweed negro | $1,000 |
| USB Oyaide Neo d+ Class B, ASIN B003TN74S6 | **Eversolo–RME actual**; USB A–B, 1 m | $700 |
| Toslink KabelDirekt, 0.5 m | Compra histórica; fuera de la ruta actual, posesión por confirmar | $150 |
| Toslink Amazon Basics, 3 m | **PC–RME actual**; ASIN pendiente porque el enlace quedó truncado | $169 |
| Ethernet Amazon Basics, ASIN B089MG7CY3 | Módem/router–Eversolo por **LAN**; plano, 9.1 m, blanco | $160 |
| Shunhong TM333-500VA, 110→220 V | Elevador incluido con el Aune; no añade una partida monetaria | Incluido en $11,000 del Aune |
...
| **Gasto histórico conocido** | **15 partidas monetarias; elevador incluido, sin doble conteo** | **$82,809** |

Distribución del gasto histórico: **casa $64,179**, incluyendo el KabelDirekt histórico; **Arya $8,000** por separado; **trabajo $7,630**; **portátil $3,000**. Casa más Arya suma $72,179. Los dos cables añadidos aportan $169 + $160 = **$329**. Si se excluye el KabelDirekt cuya posesión no está confirmada, la cadena principal de casa suma **$64,029** y el resto del registro suma **$82,659**. Estos subtotales no se suman otra vez al total. Los precios del Oyaide y del par XLR se conservan del inventario anterior; una oferta actual en Amazon no modifica lo pagado.

También están registrados un iPhone 15 Pro Max, la PC y protectores EarDial HiFi. No hay importes suficientes para integrarlos al total. El elevador sí está identificado ahora y su costo está incluido con el Aune; no es un accesorio de costo desconocido adicional. Tampoco están desglosados el cable de audífonos de cuatro pines, los accesorios RCA/mini-Toslink de trabajo, suscripciones, envíos ni mantenimiento. No se asigna costo cero a estas partidas desconocidas.
...
### Precios actuales de referencia aportados por el propietario

Actualización del 12/09/2026. Estos importes son los precios a los que el propietario indica que se consiguen los equipos actualmente. Se registran como **referencias aportadas**, no como precios oficiales de lista, cotizaciones verificadas ni sustitutos del costo histórico.

| Componente | Pagado históricamente | Precio actual aportado |
|---|---:|---:|
| HE1000se | $20,000 | $35,000 |
| Eversolo DMP-A6 | $13,500 | $10,000 |
| RME ADI-2 DAC FS | $13,000 | $26,000 |
| Aune | $11,000 | $20,000 |
| CyberPower | $4,500 | $6,000 |
| XLR + USB + Toslink + Ethernet | $2,029 | $3,000 |
| **Total de estas partidas (MXN)** | **$64,029** | **$100,000** |

La referencia actual supera el gasto histórico de estas partidas en **$35,971**. Los $11,000 históricos del Aune incluyen el elevador Shunhong; no se ha confirmado que los $20,000 actuales también lo incluyan. No se incluyen PC, Arya, KabelDirekt histórico ni partidas sin precio desglosado. No se añade este total al gasto histórico del inventario: es una comparación de valoración de las mismas partidas.
...
```text
Módem/router ── LAN Ethernet Amazon Basics, 9.1 m ── Eversolo DMP-A6
                                                         │
...
PC Linux ── Toslink Amazon Basics, 3 m ───────────→ RME ADI-2 DAC FS
                                           ...
                                           3.048 m c/u   ↓
                                                   Aune S17 Pro EVO
                                                         │ XLR audífonos, 4 pines
                                                         ↓
                                                    HIFIMAN HE1000se

Alimentación del Aune 220 V: elevador Shunhong TM333-500VA.
Ubicación exacta respecto al UPS y las tomas: por confirmar.
```
...
### Chip confirmado: ESS ES9028Q2M

**Evidencia:** fotografía de la etiqueta del propietario y [explicación de Matthias Carstens, RME, sobre la revisión C](https://forum.rme-audio.de/viewtopic.php?id=33421). Se registra el sufijo identificador; no es necesario transcribir el número de serie completo.

El ES9028Q2M es un convertidor estéreo de 32 bits de la familia SABRE, con arquitectura HyperStream. Un único chip convierte ambos canales: no se necesita un chip por canal para obtener estéreo. Los 32 bits describen capacidad de procesamiento/interfaz, no 32 bits de resolución analógica efectiva. La conversión y el filtrado reconstruyen una señal analógica a partir de las muestras digitales; su fidelidad final depende también de los circuitos externos. [Ficha técnica ESS](https://www.esstech.com/wp-content/uploads/2022/09/ES9028Q2M-Datasheet-v0.41.pdf).

| Dato del chip | ESS ES9028Q2M del RME | ESS ES9038Q2M del A6 |
|---|---|---|
| Arquitectura en la tabla de ESS | HyperStream | HyperStream II |
| Rango dinámico anunciado por ESS | 129 dB | 129 dB |
| THD+N anunciado por ESS | −120 dB | −120 dB |
| Canales por chip | 2 | 2 |
| Cantidad en el aparato | Un chip estéreo | Dos chips, según el manual del A6 original |

Fuente: [tabla comparativa oficial de ESS](https://www.esstech.com/products-overview/digital-to-analog-converters/sabre-audiophile-dacs/) y [manual del DMP-A6 original](https://music.eversolo.com/dmp/instruction/EVERSOLO-DMP-A6-User-Manual-v1.0.pdf). Los valores corresponden a chips y condiciones del fabricante, no a mediciones en las salidas XLR de estos equipos. El rango dinámico relaciona señal máxima y ruido; THD+N suma distorsión y ruido en una prueba. Una cifra más negativa de THD+N indica menor proporción de esos componentes. La tabla no autoriza a atribuir al A6 una duplicación de resolución por emplear dos chips.

**Implementación de RME:** el fabricante describe filtros propios cargados en el ESS y un margen de 2.5 dB reservado para gestionar picos entre muestras. Esos picos pueden aparecer al reconstruir una señal aunque sus muestras no superen 0 dBFS. El margen no sustituye la atenuación necesaria para los realces de EQ. La revisión ESS ofrece Brickwall en lugar del SD LD de la AK4493 y no dispone del modo DSD Direct de las AKM. RME presenta las versiones AK4493 y ESS como difíciles de distinguir sonoramente; es una afirmación del fabricante, no una prueba ciega de la unidad del propietario. [Explicación técnica de RME](https://forum.rme-audio.de/viewtopic.php?id=33421).
...
La preferencia por el Eversolo cuando ambos reproducen sin fallar es una observación distinta. En la comparación óptica anterior, con la PC apagada cambiaban simultáneamente fuente, procesamiento posible y ruido ambiental. La conexión Eversolo–RME se ha actualizado posteriormente a USB; las conclusiones de aquella comparación no constituyen una comparación nueva entre USB y óptico. Conservar la misma EQ en el RME no iguala la normalización ni el nivel anterior al DAC. No se ha demostrado en esta instalación que la interferencia de una PC gamer degrade de forma continua el audio óptico. Tampoco se ha demostrado equivalencia audible entre ambas fuentes mediante una prueba controlada.
...
### CyberPower CP1500PFCLCD: modelo confirmado

**Confirmación del propietario:** el UPS poseído es el **CP1500PFCLCD, sin «a», de 1,500 VA / 1,000 W y doce tomas**. La identificación queda resuelta; no corresponde al antiguo modelo de 900 W y diez tomas. El costo histórico permanece en $4,500.
...
|---|---|
| Compatibilidad / regulación | Fuentes de PFC activo; regulación automática AVR |
| Capacidad | **1,500 VA / 1,000 W** |
| Entrada nominal | **120 V CA**, 60 ±3 Hz |
| Salida en batería | **Senoidal, 120 V CA ±5%** |
| Tomas | **12 en total: 6 con batería y supresión; 6 sólo con supresión** |
| Recarga típica / batería | **8 h** desde descarga total; plomo-ácido sellada |
| Repuesto indicado | **RB1290X2** para CP1500PFCLCD |
| Supresión de sobretensiones | **1,445 J** |
| Protección de datos | RJ45, compatible con enlace 10/100/1000 Ethernet |
| Gestión | USB/DB9 y ranura para tarjeta de gestión de red opcional |
| Carga USB frontal | USB-A y USB-C; **5 V / 3.1 A** publicados |
...
**Qué no debe inferirse:** 1,445 J es una especificación de supresión, no un porcentaje de ruido eliminado ni una protección ilimitada. La presencia de filtro EMI/RFI no proporciona una curva de atenuación ni demuestra una mejora audible a la salida del Aune. La transferencia típica de 4 ms tampoco certifica continuidad con cada carga concreta. Los tiempos de autonomía son valores publicados para sus cargas de referencia, no minutos medidos en esta instalación.

Los VA expresan potencia aparente y los W potencia real. Para dimensionar un UPS deben respetarse ambos límites y la carga efectiva del conjunto. Los 750 W de la Corsair RM750x son capacidad de la fuente de la PC, no consumo fijo que deba sumarse como medición. La autonomía real depende de consumo y estado de batería. Es relevante saber qué aparatos usan las seis tomas con batería y cuáles las seis de sólo supresión.

**Relación con el elevador:** el UPS no debe interpretarse como una fuente de 110 V constantes para el TM333. En batería su referencia es 120 V, mientras el elevador está rotulado para 110→220 V. Una relación ideal 2:1 daría 240 V con 120 V de entrada; eso sigue siendo un cálculo, no la tensión medida ni una prueba de incompatibilidad del Aune. La comprobación útil es la salida real del elevador bajo carga y el intervalo aceptado por la unidad Aune.
...
Su función principal es **adaptar la tensión para alimentar el Aune de 220 V**. No ecualiza ni procesa señal. Puede influir indirectamente si entrega tensión inadecuada, cae bajo carga o produce zumbido/acoplamiento; no hay evidencia de que esas condiciones ocurran aquí ni de una mejora sonora causada por el elevador.

El fabricante describe núcleo anular y bobinado de aluminio; la foto muestra la carcasa, no el interior. **Toroidal no equivale a aislamiento galvánico**: faltan datos del esquema de devanados para certificar si hay separación eléctrica. El logotipo CE visible no es por sí mismo un certificado de conformidad comprobado.

Con la relación nominal ideal `220/110 = 2`, entradas de 110, 120 o 127 V darían respectivamente 220, 240 o 254 V. Son ejemplos calculados, **no mediciones de la toma ni de la salida**. La carga y regulación afectan el valor real. Para cerrar la compatibilidad interesa registrar tensión de entrada/salida bajo uso y la tolerancia de alimentación de la unidad Aune; el elevador no se ha identificado como regulador automático. No hace falta abrir ningún aparato para solicitar esa comprobación.
...
| CyberPower CP1500PFCLCD, sin «a», confirmado | 1,500 VA/1,000 W; seis de sus doce tomas no tienen batería; capacidad y autonomía finitas; mantenimiento de batería | Manual principal disponible; modelo resuelto. Falta medir la carga y autonomía reales; no hay mejora sonora medida atribuida al UPS |
...
| Cables XLR, USB, Toslink y Ethernet | Identificados XLR, USB y Ethernet; ASIN del Toslink todavía incompleto. Fiabilidad condicionada por construcción y manejo | No hay ensayos comparativos de estos ejemplares. No se adoptan promesas de silencio absoluto, superioridad de metales o mejora sonora por categoría Ethernet |
| Shunhong TM333-500VA | Rotulado 110→220 V/500 VA; fabricante distingue servicio de 300 VA y publica ciclo ambiguo | Verificar tensión real y régimen de servicio. No hay medición de regulación, ruido mecánico o aislamiento del ejemplar |
...
**Pendientes de casa, por importancia:**

1. **Alimentación:** placa exterior del Aune (tensión y consumo) y mapa de qué aparato va a cada toma del UPS, cuyo modelo ya está confirmado; tensión que recibe y entrega el TM333 con el Aune en funcionamiento. No se necesita abrir los equipos.
2. **RME en uso:** firmware, entrada seleccionada, frecuencia, EQ/Bass-Treble activos, Loudness/Crossfeed, referencia de línea, Auto Ref Level y volumen. El comentario de −7.5 dB del preset no acredita una atenuación activa.
3. **Aune:** ganancia G-L/G-H, polarización A-L/A-H, volumen habitual y temperatura después de una sesión.
4. **Eversolo:** firmware, aplicación usada realmente, pantalla con formato de la pista, salida USB seleccionada, volumen fijo/variable, normalización y posible remuestreo; PC encendida o apagada en las escuchas actuales. LAN ya está confirmada.
5. **Audífono y accesorios:** referencia/longitud del cable Aune–HE1000se, almohadillas originales o sustituidas y cualquier modificación. ASIN completo del Toslink Amazon Basics; estado del KabelDirekt y del Arya. Los modelos del Oyaide, WBC y Ethernet ya están identificados.

Los pendientes de trabajo/portátil se mantienen separados: modo LO/PRE y cableado de oficina, generación del AirPort y variante de AirPods.
...
## 12. Documentación de accesorios y fuentes de compra

Las siguientes fichas fueron elaboradas para esta instalación; **no son manuales oficiales ni certificados de ensayo**. Incluyen imágenes, explicación de conexiones, datos con su procedencia y límites de identificación. Se buscaron manuales específicos por ASIN/modelo y en páginas de producto: no se localizó un PDF independiente atribuible a estos cinco accesorios. Shunhong sí ofrece instrucciones generales y parámetros en su página web. El Toslink continúa sin ASIN completo y su ficha es provisional.
